...
public class XDriveTest extends LinearOpMode {
    ...
    public void runOpMode() {
        front_left_wheel = hardwareMap.dcMotor.get("frontLeft");
        back_left_wheel = hardwareMap.dcMotor.get("backLeft");
        back_right_wheel = hardwareMap.dcMotor.get("backRight");
        front_right_wheel = hardwareMap.dcMotor.get("frontRight");
